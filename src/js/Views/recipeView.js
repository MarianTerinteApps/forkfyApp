...
class RecipeView extends View {
  ...
  _message = '';
  _errorMessage =
    'We could not find that recipe. Please write correctly, you idiot!';
    ...
    <div class="recipe__details">
      ...
      <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
          <button class="btn--tiny btn--increase-servings" data-increse-servigs="${
  ...
  addHandlerUpdateServings(handler) {
    this._parentElement.addEventListener('click', function (e) {
      ...
      +button.dataset.increseServigs > 0 &&
        handler(+button.dataset.increseServigs);
    });
  }
